this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
      ...
      _ = function(e) {
          ...
          return o(t, [{
              ...
              value: function(e) {
                  ...
                  e && !a.classList.contains("nightmode") ? a.classList.add("nightmode") : a.classList.remove("nightmode"), this.isDarkTheme = e
              }
          }, {
              key: "setColorBlindTheme",
              value: function(e) {
                  var a = document.querySelector("body");
                  e && !a.classList.contains("colorblind") ? a.classList.add("colorblind") : a.classList.remove("colorblind"), this.isColorBlindTheme = e
              }
          }, {
              key: "connectedCallback",
              value: function() {
  ...
  function Da(e) {
      var a, s = Ga(e);
      return a = s % La.length, La[Math.floor(Math.random() * 2315)]
  }
  ...
  var Za = "IN_PROGRESS",
      ...
      ts = function(e) {
          ...
          function t() {
              ...
              return e.lastPlayedTs = o.lastPlayedTs, !e.lastPlayedTs || Na(new Date(e.lastPlayedTs), e.today) >= 1 ? (e.boardState = new Array(6).fill(""), e.evaluations = new Array(6).fill(null), e.solution = Da(e.today), e.dayOffset = Ga(e.today), e.lastCompletedTs = o.lastCompletedTs, e.hardMode = o.hardMode, e.restoringFromLocalStorage = !1, Ca("event", "level_start", {
                  level_name: Wa(e.solution)
              })) : (e.boardState = e.boardState, e.evaluations = e.evaluations, e.rowIndex = e.rowIndex, e.solution = e.solution, e.dayOffset = Ga(e.today), e.letterEvaluations = Pa(e.boardState, e.evaluations), e.gameStatus = e.gameStatus, e.lastCompletedTs = e.lastCompletedTs, e.hardMode = e.hardMode, e.gameStatus !== Za && (e.canInput = !1), e.restoringFromLocalStorage = !0), e
          }
          return o(t, [{
              key: "evaluateRow",
              value: function() {
                  if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                      ...
                      this.tileIndex = 0, this.canInput = !1
                  }
              }
          }, {
              key: "addLetter",
